...
namespace TatBlog.WebApp.Areas.Admin.Models
{
    public class PostEditModel
    {
        ...
        [MaxLength(500, ErrorMessage = "Tiêu đề tối thiếu 500 ký tự")]
        public string Title { get; set; }

        [DisplayName("Giới thiệu")]
        [Required(ErrorMessage = "Giới thiệu không được bỏ trống")]
        [MaxLength(2000, ErrorMessage = "Giới thiệu tối thiếu 2000 ký tự")]
        public string ShortDescription { get; set; }

        [DisplayName("Nội dung")]
        [Required(ErrorMessage = "Nội dung không được bỏ trống")]
        [MaxLength(5000, ErrorMessage = "Nội dung tối thiếu 5000 ký tự")]
        public string Description { get; set; }

        [DisplayName("Metadata")]
        [Required(ErrorMessage = "Metadata không được bỏ trống")]
        [MaxLength(1000, ErrorMessage = "Metadata tối thiếu 1000 ký tự")]
        ...
        [MaxLength(200, ErrorMessage = "URL Slug tối thiếu 200 ký tự")]
        ...
        [Required(ErrorMessage = "Bạn chưa nhập thẻ tên")]
